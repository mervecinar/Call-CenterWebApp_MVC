...
namespace WebApplication13.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var department = await _context.Departments.Include(d => d.CosRepresantatives)
        ...
        public async Task<IActionResult> searchC(string search)
        {
            var searching = _context.Departments.Where(t => t.DepartmentName.ToLower().Contains(search.ToLower()));
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Departments == null)
            {
                ...
                return Problem("Entity set 'BLM19417EContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
